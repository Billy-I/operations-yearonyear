...
export const BudgetsAlternative: React.FC = () => {
    ...
    <div className="mt-8">
      <div className="flex justify-between items-center mb-4">
        ...
        {title === 'Active Budgets' && (
          <button 
            onClick={() => navigate('/tracker/budgets-alt/add')}
            ...
            {budgets.map((budget, index) => (
              <tr key={index} className="border-t border-gray-200 hover:bg-gray-50">
                ...
                <td className="py-3 px-4 text-center">
                  ...
                  <button
                    className="text-gray-600 hover:text-gray-900 mx-1"
                    onClick={() => navigate(`/tracker/budgets-alt/add?budget=${budget.name}`)}
                    title="Edit Budget"
                  >
                    <FaPencilAlt />
                  </button>
...
export default BudgetsAlternative;